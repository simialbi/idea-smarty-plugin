 ...
 * from [ch.erlebnisplus.smarty.psi.impl.SmartyNamedElementImpl], wired in with `mixin=`. The
 ...
 * [ch.erlebnisplus.smarty.psi.impl.SmartyPsiImplUtil].
 *
 * [NavigationItem] is what [ch.erlebnisplus.smarty.SmartyChooseByNameContributor] hands to the
